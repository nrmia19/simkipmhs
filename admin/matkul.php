...
<body>
  ...
  <div class="row no-gutters">
  	...
  	<div class="col-md-10 p-5 pt-4">
  		<h3><i class="fas fa-users-cog"></i> Daftar Matkul</h3>  <hr class="bg-secondary">
  		<a class="btn btn-primary btn-sm" href="form_matkul.php"><i class ="fas fa-plus "></i> Tambah Data</a>
	  	...
	  	<table class="table table-striped mt-3 table-bordered">
			  ...
			  <tbody>
			  	<?php 
					...
					tb_matkul.id_dosen,
					tb_dosen.nama_dosen
					FROM tb_matkul INNER JOIN tb_dosen ON tb_dosen.id_dosen=tb_matkul.id_dosen order by id_matkul") or die(mysqli_error($conn));
					$nomor = 1 ;
					while($cetak = mysqli_fetch_array($lihat)){
					?>
			    <tr>
			      <td><?php echo $nomor++; ?></td>
			      <td><?php echo $cetak['kd_matkul']; ?></td>
			      <td><?php echo $cetak['nama_matkul']; ?></td>
			      <td><?php echo $cetak['sks']; ?></td>
				  <td><?php echo $cetak['nama_dosen']; ?></td>
			      <td>
			      	<a class="btn btn-primary btn-sm" href="read_matkul.php?id_matkul=<?php echo $cetak['id_matkul']; ?>"> <i class="fas fa-sliders-h" data-toggle="tooltip" title="Read"></i> </a> |
					<a class="btn btn-success btn-sm" href="edit_matkul.php?id_matkul=<?php echo $cetak['id_matkul']; ?>"> <i class="far fa-edit" data-toggle="tooltip" title="Edit"></i> </a> |
					<a class="btn btn-danger btn-sm" href="delete_matkul.php?id_matkul=<?php echo $cetak['id_matkul']; ?>"> <i class="far fa-trash-alt" data-toggle="tooltip" title="Hapus"></i>  </a>
			      </td>
			    </tr>
			  <?php } ?>
			  </tbody>
