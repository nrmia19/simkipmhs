...
<body>
  ...
  <div class="row no-gutters">
  	...
  	<div class="col-md-10 p-5 pt-4">
  		...
  		<a class="btn btn-primary btn-sm" href="form_kelas.php"><i class ="fas fa-plus "></i> Tambah Data</a>
	  	...
	  	<table class="table table-striped mt-3 table-bordered">
			  ...
			  <tbody>
			  	<?php 
					...
					$lihat = mysqli_query($conn,"SELECT * FROM tb_kelas order by id_kelas") or die(mysqli_error($conn));
					$nomor = 1 ;
			    ...
			    <tr>
			      ...
			      <td>
			      	<a class="btn btn-danger btn-sm" href="delete_kelas.php?id_kelas=<?php echo $cetak['id_kelas']; ?>"> <i class="far fa-trash-alt" data-toggle="tooltip" title="Hapus"></i>  </a>
			      </td>
			    </tr>
			  <?php } ?>
			  </tbody>
