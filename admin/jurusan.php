...
<body>
  ...
  <div class="row no-gutters">
  	...
  	<div class="col-md-10 p-5 pt-4">
  		<h3><i class="fas fa-users-cog"></i> Daftar Jurusan</h3>  <hr class="bg-secondary">
  		<a class="btn btn-primary btn-sm" href="form_jurusan.php"><i class ="fas fa-plus "></i> Tambah Data</a>
			<a class="btn btn-success btn-sm" href="cetak_jurusan.php"> <i class ="fas fa-print "></i> Cetak Data</a>
	  	...
	  	<table class="table table-striped mt-3 table-bordered">
			  ...
			  <tbody>
			  	<?php 
					...
					$lihat = mysqli_query($conn,"SELECT * FROM tb_jurusan order by id_jurusan") or die(mysqli_error($conn));
					$nomor = 1 ;
					while($cetak = mysqli_fetch_array($lihat)){
					?>
			    <tr>
			      <td><?php echo $nomor++; ?></td>
			      <td><?php echo $cetak['kd_jurusan']; ?></td>
			      <td><?php echo $cetak['nama_jurusan']; ?></td>
			      <td><?php echo $cetak['jenjang']; ?></td>
			      <td>
					<a class="btn btn-danger btn-sm" href="delete_jurusan.php?id_jurusan=<?php echo $cetak['id_jurusan']; ?>"> <i class="far fa-trash-alt" data-toggle="tooltip" title="Hapus"></i>  </a>
			      </td>
			    </tr>
			  <?php } ?>
			  </tbody>
