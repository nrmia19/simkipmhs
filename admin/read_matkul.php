  ...
  <div class="row no-gutters">
  	...
  	<div class="col-md-10 p-5 pt-4">
  		...
  		<?php 
			...
			tb_matkul.id_dosen,
			tb_dosen.nama_dosen
			FROM tb_matkul INNER JOIN tb_dosen ON tb_dosen.id_dosen=tb_matkul.id_dosen 
            WHERE id_matkul='$id_matkul' ") or die(mysqli_error($conn));
			while($cetak = mysqli_fetch_array($lihat)){
		?>
				  	
	  	<table class="table table-striped mt-3" style="width:800px">
			    <tr>
			      <th style="width:300px">Kode Matkul</th>
            ...
            <a class="btn btn-danger btn-sm" href="matkul.php">Back</a>    
  	</div>
  </div>
