...
<body>
  ...
  <div class="row no-gutters">
  	...
  	<div class="col-md-10 p-5 pt-4">
        ...
        <h6 class="te mt-4"> Mahasiswa Jurusan : Teknik Industri </h6>
			  ...
			  <tbody>
			  	<?php
			  		...
			  		$lihat = mysqli_query($conn, "SELECT 
						...
						INNER JOIN tb_kelas ON tb_mahasiswa.id_kelas=tb_kelas.id_kelas WHERE nama_jurusan='Teknik Industri'order by nama_mahasiswa;") 
