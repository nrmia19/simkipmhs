...
<body>
  ...
  <div class="row no-gutters">
  	...
  	<div class="col-md-10 p-5 pt-4">
  		<h3><i class="fas fa-paperclip"></i> Transkrip Nilai</h3>  <hr class="bg-secondary">
  		<a class="btn btn-primary btn-sm" href="form_transkrip.php"><i class ="fas fa-plus "></i> Tambah Data</a>
			<a class="btn btn-success btn-sm" href="cetak_transkrip.php"> <i class ="fas fa-print "></i> Cetak Data</a>
	  	...
	  	<table class="table table-striped mt-3 table-bordered">
			  ...
			  <tbody>
			    <tr>
			      ...
			      <td></td>
			      <td>
			      	<a class="btn btn-primary btn-sm" href="read_transkrip.php?id_transkrip=<?php echo $cetak['id_transkrip']; ?>"> <i class="fas fa-sliders-h" data-toggle="tooltip" title="Read"></i> </a> |
							<a class="btn btn-success btn-sm" href="edit_transkrip.php?id_transkrip=<?php echo $cetak['id_transkrip']; ?>"> <i class="far fa-edit" data-toggle="tooltip" title="Edit"></i> </a> |
							<a class="btn btn-danger btn-sm" href="delete_transkrip.php?id_transkrip=<?php echo $cetak['id_transkrip']; ?>"> <i class="far fa-trash-alt" data-toggle="tooltip" title="Hapus"></i>  </a>
			      </td>
			    </tr>
