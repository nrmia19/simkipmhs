  	...
  	<div class="col-md-10 p-5 pt-4">
  		...
  		<div class="cotainer">
  			<div class="content">
  				...
  				<form action="add_jurusan.php" method="post" class="form-horizontal mt-4">
  					<div class="row mb-3 form-group">
					    <label for="kd_jurusan" class="col-sm-2 col-form-label">Kode Jurusan</label>
					    <div class="col-sm-5">
  							<input type="text" class="form-control" id="kd_jurusan" name="kd_jurusan" placeholder="Kode Jurusan">
					    </div>
					  </div>
					  <div class="row mb-3 form-group">
