...
<body>
  ...
  <div class="row no-gutters">
  	...
  	<div class="col-md-10 p-5 pt-4">
  		<h3><i class="fas fa-swatchbook"></i> Daftar Matkul</h3>  <hr class="bg-secondary">
  		<div class="cotainer">
  			<div class="content">
  				<h4> Tambah Data Matkul   </h4>
  				<form action="add_matkul.php" method="post" class="form-horizontal mt-4">
					  <div class="row mb-3 form-group">
					    <label for="kd_matkul" class="col-sm-2 col-form-label">Kode Matkul</label>
					    <div class="col-sm-5">
  							<input type="text" class="form-control" id="kd_matkul" name="kd_matkul" placeholder="Kode Matkul">
					    </div>
					  </div>
					  <div class="row mb-3 form-group">
					    <label for="nama_matkul" class="col-sm-2 col-form-label">Nama Matkul</label>
					    <div class="col-sm-5">
					      <input type="text" class="form-control" id="nama_matkul" name="nama_matkul" placeholder="Nama Matkul">
					    </div>
					  </div>
					  <div class="row mb-3 form-group">
					  ...
					  <div class="row mb-3 form-group">
					    <label for="text-input" class="col-sm-2 col-form-label">Dosen Pengampu</label>
					    <div class="col-sm-5">
					      <select class="form-select" name="id_dosen" id="id_dosen">
					      	<option value="">Dosen Pengampu</option>
					      		<?php 
									include '../koneksi/koneksi.php';
									$query = mysqli_query($conn, "SELECT * FROM tb_dosen GROUP BY id_dosen");
