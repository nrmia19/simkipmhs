...
<body>
  ...
  <div class="row no-gutters">
  	...
  	<div class="col-md-10 p-5 pt-4">
  		...
  		<a class="btn btn-primary btn-sm" href="form_mahasiswa.php"><i class ="fas fa-plus "></i> Tambah Data</a>
		<a class="btn btn-success btn-sm" href="cetak_mahasiswa.php"> <i class ="fas fa-print "></i> Cetak Data</a> <br>
		<a class="btn btn-secondary btn-sm mt-3" href="mahasiswatif.php">Lihat Mahasiswa Teknik Informatika</a>
		<a class="btn btn-secondary btn-sm mt-3" href="mahasiswati.php">Lihat Mahasiswa Teknik Industri</a>
		<a class="btn btn-secondary btn-sm mt-3" href="mahasiswate.php">Lihat Mahasiswa Teknik Elektro</a>

        <h6 class="te mt-4"> Mahasiswa Jurusan : Teknik Informatika </h6>
			  ...
			  <tbody>
			  	<?php
			  		...
			  		$lihat = mysqli_query($conn, "SELECT 
						...
						INNER JOIN tb_kelas ON tb_mahasiswa.id_kelas=tb_kelas.id_kelas WHERE nama_jurusan='Teknik Informatika'order by nama_mahasiswa;") 
			    ...
			    <tr>
			      ...
			      <td>
			      	<a class="btn btn-primary btn-sm" href="read_mahasiswa.php?id_mahasiswa=<?php echo $cetak['id_mahasiswa']; ?>"> <i class="fas fa-sliders-h" data-toggle="tooltip" title="Read"></i> </a> |
					<a class="btn btn-success btn-sm" href="edit_mahasiswa.php?id_mahasiswa=<?php echo $cetak['id_mahasiswa']; ?>"> <i class="far fa-edit" data-toggle="tooltip" title="Edit"></i> </a> |
					<a class="btn btn-danger btn-sm" href="delete_mahasiswa.php?id_mahasiswa=<?php echo $cetak['id_mahasiswa']; ?>"> <i class="far fa-trash-alt" data-toggle="tooltip" title="Hapus"></i>  </a>
			      </td>
			    </tr>
			  <?php } ?>	
			  </tbody>
